...
@Component({
    selector: 'app-model-list-ng-prime',
    // templateUrl: './model-list-ng-prime.html',
    templateUrl: '../../generic/generic.table.list.html',
    // styleUrls: ['./model-list-ng-prime.scss'],
    providers: [MessageService],
    inputs: [ 'listTemplate' ],
})
export class ModelListPrimeNgComponent extends GenericTableList<any, number> {
    public columns: any = [];

    public query = '';
    public filteredList = [];
    public elementRef;
    public listTemplate: string = 'MODELS';
