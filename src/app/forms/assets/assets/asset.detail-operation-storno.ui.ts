...
@Component({
    selector: 'app-asset-detail-operation-storno-ui',
    templateUrl: 'asset.detail-operation-storno.ui.html',
    styleUrls: ['asset.detail-operation-storno.ui.scss'],
...
export class AssetDetailUIOperationStornoComponent implements AfterViewInit, OnInit  {
