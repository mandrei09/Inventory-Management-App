...
@Component({
    selector: 'acquisition-validate-read-only-list',
    // templateUrl: '../../assets/assets/acquisition-validate-read-only.list.html',
    templateUrl: '../../generic/generic.table.list.html',
    inputs: [ 'listTemplate' ],
    outputs: [ 'listAtferViewInit' ]
})

export class AcquisitionValidateReadOnlyOfferListComponent extends GenericTableList<any, number> implements AfterViewInit {
    public query = '';
    public filteredList = [];
    public elementRef;
