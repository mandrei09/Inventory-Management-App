...
@Component({
    selector: 'app-asset-wfh-list',
    templateUrl: './assets-wfh-filters-list/assets-wfh-filters.list.html',
    styleUrls: ['./asset-wfh.list.scss'],
    inputs: [ 'listTemplate', 'clearFilters' ],
})

export class AssetWFHListComponent extends GenericTableList<any, number> {
    ...
    public get partner(): Partner[] { return this._partner; }
    public set partner(value: Partner[]) {
      this._partner = value;
      this.getAssetColumnFilters();
    }
