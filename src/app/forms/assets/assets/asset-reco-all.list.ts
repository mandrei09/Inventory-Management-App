...
@Component({
    selector: 'app-asset-reco-all-list',
    templateUrl: '../../assets/assets/asset-reco-all.list.html',
    // host: {
    //     '(document:click)': 'handleClick($event)'
    // },
    inputs: [ 'listTemplate' ],
})
export class AssetRecoAllListComponent extends GenericTableList<any, number> {
    public query = '';
    public filteredList = [];
    public elementRef;
    public listTemplate: string = 'ASSETRECOALL';
