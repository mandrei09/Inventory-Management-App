...
@Component({
  selector: 'app-asset-clone-dialog',
  templateUrl: './asset-clone-dialog.component.html',
  styleUrls: ['./asset-clone-dialog.component.scss']
})
export class AssetCloneDialogComponent implements AfterViewInit, OnInit {
