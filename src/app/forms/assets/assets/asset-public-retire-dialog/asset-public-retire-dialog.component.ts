...
@Component({
  selector: 'app-asset-retire-operation-dialog',
  templateUrl: './asset-public-retire-dialog.component.html',
  styleUrls: ['./asset-public-retire-dialog.component.scss']
})
export class AssetPublicRetireDialogComponent implements AfterViewInit, OnInit {
