...
@Component({
    selector: 'app-asset-detail-validate-ui',
    templateUrl: 'asset.detail-validate.ui.html',
    styleUrls: ['asset.detail-validate.ui.scss'],
...
export class AssetDetailUIValidateComponent implements AfterViewInit  {
