...
@Component({
  ...
  templateUrl: './asset-sap-operation-dialog.component.html',
  styleUrls: ['./asset-sap-operation-dialog.component.scss']
})
export class AssetSapOperationDialogComponent implements AfterViewInit, OnInit {
