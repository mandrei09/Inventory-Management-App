...
import {AssetTransferSAP, SaveAssetCloneTransfer} from '../../../../model/api/assets/asset-transfer';
...
@Component({
  selector: 'app-asset-storno-operation-dialog',
  templateUrl: './asset-storno-dialog.component.html',
  styleUrls: ['./asset-storno-dialog.component.scss']
})
export class AssetStornoDialogComponent implements AfterViewInit, OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<AssetStornoDialogComponent>,
  ...
  public updateAssetDetails(asset: any) {
    ...
    this.refDocNo = asset.errorRetire.length > 0 ?  asset.errorRetire[0].belnr : '';
