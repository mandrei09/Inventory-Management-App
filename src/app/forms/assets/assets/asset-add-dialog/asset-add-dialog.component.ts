...
import { CostCenterSelectionDialog } from "../../../administrations/cost-centers/selection/cost-center.selection.dialog";
import { DialogService } from "../../../../services/dialog.service";
import { EmployeesSelectionDialog } from "../../../administrations/employees/selection/employees.selection.dialog";

@Component({
  selector: "app-asset-add-edit",
  templateUrl: "./asset-add-dialog.component.html",
  styleUrls: ["./asset-add-dialog.component.scss"],
})
export class AssetAddDialogComponent implements AfterViewInit {
  isPreReception: boolean;

  public _order: Order = null;
  ...
  @ViewChild("assetCategoryDetail")
  public assetCategoryDetail: AssetCategoryDetailComponent;
  @ViewChild("assetCategoryList")
  public assetCategoryList: AssetCategoryListComponent;

  @ViewChild("assetCategoryDetailModal")
  public assetCategoryDetailModal: ModalDirective;
  ...
  @ViewChild("dictionaryItemList")
  public dictionaryItemList: DictionaryItemListComponent;

  @ViewChild("dictionaryItemDetailModal")
  public dictionaryItemDetailModal: ModalDirective;
  @ViewChild("dictionaryItemListModal")
  public dictionaryItemListModal: ModalDirective;
  ...
  @ViewChild("assetTypeDetailModal")
  public assetTypeDetailModal: ModalDirective;
  ...
  @ViewChild("costCenterReceptionList")
  public costCenterReceptionList: CostCenterListComponent;
  @ViewChild("costCenterReceptionListModal")
  public costCenterReceptionListModal: ModalDirective;

  @ViewChild("employeeReceptionList")
  public employeeReceptionList: EmployeeListComponent;
  @ViewChild("employeeReceptionListModal")
  public employeeReceptionListModal: ModalDirective;
  ...
  @ViewChild("assetNatureList")
  public assetNatureList: AssetNatureListComponent;
  @ViewChild("assetNatureListModal")
  public assetNatureListModal: ModalDirective;
  ...
  @ViewChild("dimensionListFinal")
  public dimensionListFinal: DimensionListComponent;
  @ViewChild("dimensionListFinalModal")
  public dimensionListFinalModal: ModalDirective;
  ...
  @ViewChild("departmentDetailModal")
  public departmentDetailModal: ModalDirective;
  @ViewChild("departmentListModal") public departmentListModal: ModalDirective;

  @ViewChild("dimensionDetail")
  public dimensionDetail: DimensionDetailComponent;
  @ViewChild("dimensionList") public dimensionList: DimensionListComponent;

  @ViewChild("dimensionDetailModal")
  public dimensionDetailModal: ModalDirective;
  @ViewChild("dimensionListModal") public dimensionListModal: ModalDirective;

  @ViewChild("administrationDetail")
  public administrationDetail: AdministrationDetailComponent;
  @ViewChild("administrationList")
  public administrationList: AdministrationListComponent;
  @ViewChild("administrationDetailModal")
  public administrationDetailModal: ModalDirective;
  ...
  @ViewChild("assetOpDetailList")
  public assetOpList: AssetOpDetailListComponent;
  @ViewChild("entityFileList") public entityFileList: EntityFileListComponent;

  @ViewChild("confirmationModal") public confirmationModal: ModalDirective;
  @ViewChild("assetTypeDropDownList")
  public assetTypeDropDownList: AssetTypeDropDownListComponent;
  // @ViewChild('documentTypeDropDownList') public documentTypeDropDownList: DocumentTypeDropDownListComponent;

  @ViewChild("requestBudgetForecastList")
  public requestBudgetForecastList: RequestBudgetForecastListComponent;
  @ViewChild("requestBudgetForecastMaterialList")
  public requestBudgetForecastMaterialList: RequestBudgetForecastMaterialListComponent;
  @ViewChild("requestBFMaterialCostCenterList")
  public requestBFMaterialCostCenterList: RequestBudgetForecastMaterialCostCenterListComponent;
  @ViewChild("requestBFMaterialCostCenterAllList")
  public requestBFMaterialCostCenterAllList: RequestBudgetForecastMaterialCostCenterListComponent;
  ...
  public assetSearchCategory: boolean =
    AppConfig.SHOW_ASSET_DETAILS_SEARCH_CATEGORY;
  ...
  public assetTypeDetailsButton: boolean =
    AppConfig.SHOW_ASSETTYPE_DETAILS_BUTTON;
  public assetEmployeeDetailsButton: boolean =
    AppConfig.SHOW_EMPLOYEE_DETAILS_BUTTON;
  ...
  public assetRegionDetailsButton: boolean =
    AppConfig.SHOW_REGIONS_DETAILS_BUTTON;
  public assetCostCenterDetails: boolean = AppConfig.SHOW_COSTCENTER_DETAILS;
  public assetCostCenterDetailsButton: boolean =
    AppConfig.SHOW_COSTCENTER_DETAILS_BUTTON;
  public assetLocationDetails: boolean = AppConfig.SHOW_LOCATION_DETAILS;
  public assetLocationDetailsButton: boolean =
    AppConfig.SHOW_LOCATION_DETAILS_BUTTON;
  ...
  public assetSuppliersDetailsAdd: boolean =
    AppConfig.SHOW_ASSET_DETAILS_SUPPLIER_ADD;
  public assetSerieDetailsDoc1: boolean =
    AppConfig.SHOW_ASSET_DETAILS_SERIE_DOC1;
  public assetSerieDetailsDoc2: boolean =
    AppConfig.SHOW_ASSET_DETAILS_SERIE_DOC2;
  ...
  public selectedAssetCategories: Array<AssetCategory> =
    new Array<AssetCategory>();
  ...
  requestBudgetForecastMaterialCostCenterUpdate =
    new Array<RequestBudgetForecastMaterialCostCenterUpdate>();
  requestBudgetForecastMaterialCostCenterMultiple =
    new Array<RequestBudgetForecastMaterialCostCenterMultiple>();
  ...
  constructor(
    ...
    if (data && data.order) {
      setTimeout(() => {
        ...
        this.isPreReception = data.isPreReception;
        console.log(this.isPreReception);
      }, 500);
    }
  ...
  public setSelectedItem($event) {
    ...
    this.requestBFMaterialCostCenterList.selectedItems =
      selectedRequestBFMaterialCostCenters;

    let selectedRequestBudgetForecastMaterials = new Array<any>();
    this.requestBudgetForecastMaterialList.selectedItems =
      selectedRequestBudgetForecastMaterials;
    ...
    params.push(
      new Param("orderId", this.order != null ? this.order.id.toString() : null)
    );
    ...
    params.push(
      new Param(
        "requestBudgetForecastMaterialIds",
        AppUtils.getIdsList<RequestBudgetForecastMaterial, number>([
          this.requestBudgetForecastMaterialList.selectedItem != null
            ? this.requestBudgetForecastMaterialList.selectedItem
            : null,
        ])
      )
    );
  ...
  public setSelectedOrder(value) {
    ...
    if (
      ...
      this.order.contract.contractID === "NO-C"
    ) {
      this.notificationService.showWarning(
        "Comanda selectata nu are CONTRACT!",
        "IMPORTANT",
        0,
        false,
        0
      ...
      params.push(
        new Param(
          "requestIds",
          AppUtils.getIdsList<Request, number>([
            this.order != null &&
            this.order.offer != null &&
            this.order.offer.request != null
              ? this.order.offer.request
              : null,
          ])
        )
      );
      ...
      params.push(
        new Param(
          "orderId",
          this.order != null ? this.order.id.toString() : null
        )
      );
  ...
  public setSelectedLocation() {
    ...
    if (this.location != null) {
      if (
        this.room != null &&
        this.room.location != null &&
        this.room.location.id !== this.location.id
      ) {
        this.room = null;
      }
    }
  ...
  public selectUomFinal() {
    ...
    params.push(
      new Param(
        "assetCategoryIds",
        this.assetCategory != null ? this.assetCategory.id.toString() : null
      )
    );
  ...
  public saveAsset() {
    ...
    if (this.filesToUpload.length > 0) {
      ...
      this.entityFileHttpService
        .addAssetFiles(this.filesToUpload, guid, "NEWASSET")
        .subscribe((res: EntityFileResult) => {
          if (res.entityFileId === 251615) {
            this.isSaved = false;
            // this.asset.guid = guid;
            // this.asset.companyId = this.order != null && this.order.offer != null && this.order.offer.company != null ? this.order.offer.company.id : 5;
      ...
      // this.asset.name = this.dictionaryItem != null ? this.dictionaryItem.name : this.asset.name;
      // this.asset.orderId = this.order != null ? this.order.id : null;
      // this.asset.assetEntityId = this.assetEntity != null ? this.assetEntity.id : null;
      // this.asset.documentTypeId = this.documentType != null ? this.documentType.id : null;
      // this.asset.dictionaryItemId = this.dictionaryItem != null ? this.dictionaryItem.id : null;
      // this.asset.name2 = this.asset.name2;
      // //this.asset.subCategoryId = this.subCategory != null ? this.subCategory.id : null;
      ...
      // this.asset.multipleQuantity = this.multipleQuantity;
      // this.asset.validated = true;

      this.requestBudgetForecastList.selectedItems.forEach((element) => {
        this.asset.requestBudgetForecasts.push(element.id);
      });
      if (this.isPreReception) {
        this.assetHttpService
          .addPreReceptionAsset(this.asset)
          .subscribe((result: CreateAssetSAPResult) => {
            if (result.success) {
              this.notificationService.showInfo(
                result.errorMessage,
                "Adaugare prereceptie asset",
                5000,
                false,
                0
              );
  ...
  public onRequestBudgetForecastMaterialListSelectionChanged(
    assetOpDetails: Array<any>
  ) {
    // this.asset.name2 = '';
    // this.asset.receptionPrice = 0;
    this.material = null;
    if (
      this.requestBudgetForecastMaterialList.selectedItem != null &&
      this.requestBudgetForecastMaterialList.selectedItem.appState.id === 7
    ) {
      this.material =
        this.requestBudgetForecastMaterialList.selectedItem.material;
      ...
      this.notificationService.showWarning(
        "Produsul " +
          this.requestBudgetForecastMaterialList.selectedItem.material.code +
          " a fost receptionat deja!",
        "Stare produs din comanda",
        0,
        false,
        0
      );
  ...
  public onEntityFileListSelectionChanged(entityFiles: Array<EntityFile>) {
    this.entityFile =
      entityFiles != null && entityFiles.length === 1 ? entityFiles[0] : null;
  }
    ...
    if (this.selectedAssetOp != null) {
      ...
      if (validReport) {
        ...
        if (AppConfig.DOCUMENT_TYPE_INVENTORY) {
          window.open(
            `${AppConfig.reportingServer}Report.aspx/?report=${reportType}&documentId=${this.selectedAssetOp.document.id}&assetOpId=${this.selectedAssetOp.id}`
          );
        } else {
          window.open(
            `${AppConfig.reportingServer}Report.aspx/?report=${reportType}&documentId=${this.selectedAssetOp.document.id}`
          );
        }
      }
    }
  ...
  public processAssetOp() {
    this.assetOpHttpService
      .process(this.assetOpList.selectedItem.id)
      .subscribe((data) => {
        this.refreshAssetOperations();
      });
  }
  ...
  public printBarcodeLabel() {
    ...
    popupWinindow.document.write(
      '<html><head><link rel="stylesheet" /></head><body onload="window.print()">' +
        "<div>" +
        innerContents +
        "</div>" +
        "</html>"
  ...
  public selectEmployeeReception() {
    ...
    params.push(
      new Param(
        "exceptEmployeeIds",
        AppUtils.getIdsList<EmployeeResource, number>(this.selectedEmployees())
      )
    );
  ...
  onEmployeeReceptionAdd() {
    let dialogRef = this.dialog.open(EmployeesSelectionDialog, {
      panelClass: "centered-middle-modal",
      width: "80%",
      maxWidth: "90%",
      maxHeight: "80%",
      height: "auto",
      position: { top: "10em" },
      data: { params: this.employeeParams },
    });

    dialogRef.afterClosed().subscribe((items: any) => {
      // this.requestBudgetForecastList.refresh();
      if (items.length > 0) {
        this.setSelectedEmployeeReception(items);
      }
    });
  }
  ...
  private selectedEmployees(): Array<EmployeeResource> {
    let mappedEmployees: Array<EmployeeResource> =
      new Array<EmployeeResource>();
  ...
  public setSelectedEmployeeReception(value) {
    ...
    if (this.employee != null) {
      ...
      data.requestBFMaterialCostCenterId =
        this.requestBFMaterialCostCenterList.selectedItem.id;

      this.requestBFMaterialCostCenterHttpService
        .updateEmployeeByRequestBudgetForecast(data)
        .subscribe(
          (res) => {
            if (res.statusCode === 200) {
              this.notificationService.showInfo(
                "Operatia a fost finalizata cu success!",
                "Actualizare utilizator mapat",
                5000,
                false,
                0
              );
  ...
  public get costCenterParams(): Array<Param> {
    ...
    params.push(
      new Param(
        "exceptCostCenterIds",
        AppUtils.getIdsList<CodeNameEntity, number>(this.selectedCostCenters())
      )
    );
  ...
  onCostCenterReceptionAdd() {
    let dialogRef = this.dialog.open(CostCenterSelectionDialog, {
      panelClass: "centered-middle-modal",
      width: "80%",
      maxWidth: "90%",
      maxHeight: "90%",
    ...
    dialogRef.afterClosed().subscribe((items: any) => {
      // this.requestBudgetForecastList.refresh();
      if (items.length > 0) {
        this.setSelectedCostCenterReception(items);
      }
    });
  }
  ...
  public setSelectedCostCenterReception(value) {
    ...
    const costCentersIds: RequestBFMaterialCostCenterAdd =
      new RequestBFMaterialCostCenterAdd();
    items.forEach((item) => {
    ...
    costCentersIds.requestBudgetForecastMaterialId =
      this.requestBudgetForecastMaterialList.selectedItem != null
        ? this.requestBudgetForecastMaterialList.selectedItem.id
        : 0;

    this.requestBFMaterialCostCenterHttpService
      .addMaterialByRequestBudgetForecast(costCentersIds)
      .subscribe(
        (res) => {
          if (res.statusCode === 200) {
            this.notificationService.showSuccess(
              "Datele au fost salvate cu success!",
              "Adauga mapare centru de cost",
              0,
              false,
              0
            );
  ...
  public onDeleteRequestBFMaterialEmployee() {
    this.operationType =
      OperationType.DeleteRequestBFMaterialCostCenterEmployee;
  ...
  public deleteRequestBFMaterialCostCenter() {
    this.requestBFMaterialCostCenterHttpService
      .deleteMaterialByRequestBudgetForecast(
        this.requestBFMaterialCostCenterList.selectedItem.id
      )
      .subscribe(
        (res) => {
  ...
  public deleteRequestBFMaterialCostCenterEmployee() {
    this.requestBFMaterialCostCenterHttpService
      .removeMaterialByRequestBudgetForecastEmployee(
        this.requestBFMaterialCostCenterList.selectedItem.id
      )
      .subscribe(
        (res) => {
  ...
  public saveCostCenterValidated() {
    this.requestBudgetForecastMaterialCostCenterUpdate =
      new Array<RequestBudgetForecastMaterialCostCenterUpdate>();

    this.requestBFMaterialCostCenterList.items.forEach((element) => {
      // console.log(JSON.stringify(element));
      this.requestBudgetForecastMaterialCostCenterUpdate.push(
        new RequestBudgetForecastMaterialCostCenterUpdate(
          element.id,
          element.quantity,
          element.valueRon
        )
    ...
    this.requestBFMaterialCostCenterHttpService
      .requestBFMaterialCostCenterUpdate(
        this.requestBudgetForecastMaterialCostCenterUpdate
      )
      .subscribe(
        (res) => {
  ...
  public updateCostCenterMultiple() {
    this.requestBudgetForecastMaterialCostCenterMultiple =
      new Array<RequestBudgetForecastMaterialCostCenterMultiple>();

    this.requestBFMaterialCostCenterList.items.forEach((element) => {
      // console.log(JSON.stringify(element));
      this.requestBudgetForecastMaterialCostCenterMultiple.push(
        new RequestBudgetForecastMaterialCostCenterMultiple(
          element.id,
          element.multiple
        )
      );
    ...
    this.requestBFMaterialCostCenterHttpService
      .requestBFMaterialCostCenterMultiple(
        this.requestBudgetForecastMaterialCostCenterMultiple
      )
      .subscribe(
        (res) => {
  ...
  public changeRowSelection() {
    if (this.assetRowSelection === "single") {
      ...
      this.requestBudgetForecastList.selectedItems =
        selectedRequestBudgetForecasts;
  ...
  public get sumMaxMaterialCostCenters(): boolean {
    ...
    let result = [];
    if (
      this.requestBFMaterialCostCenterAllList != null &&
      this.requestBFMaterialCostCenterAllList.items.length > 0
    ) {
      this.requestBFMaterialCostCenterAllList.items.reduce(function (
        res,
        value
      ) {
        if (!res[value.requestBGTFM.id]) {
          res[value.requestBGTFM.id] = {
            requestBGTFMId: value.requestBGTFM.id,
            quantity: 0,
            maxQuantity: 0,
            valueRon: 0,
            maxValueRon: 0,
...
class Guid {
  static newGuid() {
    return "xxxxxxxx-xxxx-3xxx-yxxx-xxxxxxxxxxxx".replace(
      /[xy]/g,
      function (c) {
