...
@Component({
    selector: 'app-asset-rejected-manage',
    templateUrl: 'asset-rejected.manage.html',
    styleUrls: ['asset-rejected.manage.scss'],
    providers: [
        AccMonthHttpService,
...
export class AssetRejectedManageComponent implements AfterViewInit { // extends GenericManage<AssetInvDetail> {
