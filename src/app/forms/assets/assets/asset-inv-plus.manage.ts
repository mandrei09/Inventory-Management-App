...
@Component({
    selector: 'app-asset-inv-plus-manage',
    templateUrl: 'asset-inv-plus.manage.html',
    styleUrls: ['asset-inv-plus.manage.scss'],
    providers: [
        AccMonthHttpService,
...
export class AssetInvPlusManageComponent implements AfterViewInit { // extends GenericManage<AssetInvDetail> {
...
//   };
    ...
    public editAsset() {
        ...
        if (selectedAssetId > 0) {
            this.router.navigate(['/assetvalidateinvplus', selectedAssetId]);
        }
    }
