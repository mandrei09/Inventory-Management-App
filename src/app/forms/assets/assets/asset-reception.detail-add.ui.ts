...
@Component({
    selector: 'app-asset-reception-detail-add-ui',
    templateUrl: 'asset-reception.detail-add.ui.html',
    styleUrls: ['asset-reception.detail-add.ui.scss'],
...
export class AssetReceptionDetailUIAddComponent implements AfterViewInit  {
