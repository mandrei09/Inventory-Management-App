...
@Component({
    selector: 'offer-validate-read-only-list',
    // templateUrl: '../../assets/assets/offer-validate-read-only.list.html',
    templateUrl: '../../generic/generic.table.list.html',
    inputs: [ 'listTemplate' ],
    outputs: [ 'listAtferViewInit' ]
})

export class OfferValidateReadOnlyOfferListComponent extends GenericTableList<any, number> implements AfterViewInit {
    public query = '';
    public filteredList = [];
    public elementRef;
