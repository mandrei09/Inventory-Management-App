...
@Component({
    selector: 'order-validate-read-only-list',
    templateUrl: '../../assets/assets/order-validate-read-only.list.html',
...
export class OrderValidateReadOnlyOfferListComponent extends GenericTableList<any, number> implements AfterViewInit {
    public query = '';
    public filteredList = [];
    public elementRef;
