...
@Component({
    selector: 'app-asset-scrap-manage',
    templateUrl: 'asset-scrap.manage.html',
    styleUrls: ['asset-scrap.manage.scss'],
    providers: [
        AccMonthHttpService,
...
export class AssetScrapManageComponent implements AfterViewInit { // extends GenericManage<AssetInvDetail> {
...
//   };
    ...
    onFARUpload() {
        ...
        //   panelClass: 'centered-middle-modal', height: '80%', maxHeight: '80%', disableClose: true, width: '700px', position: { bottom: '15%', top: 'auto'},
        //   data: {}
        // });
...
public exportThales() {
    ...
    public export() {
      ...
      (error) => {
        if(error.status==418)
          {
            this.notification.showWarning('Exportul nu contine date!', '', 0, false, 0)
            return;
          }
        }
      );
