...
export class AssetEditComponent implements AfterViewInit {
  ...
  public _expAccounts: ExpAccount = null;
  public get expAccounts(): ExpAccount { return this._expAccounts; }
  public set expAccounts(value: ExpAccount) {
    this._expAccounts = value;

    this.expAccount = value;
  }

  public _companies: Company = null;
  ...
  public _costCenters: CostCenter = null;
  ...
  public _employees: Employee = null;
  ...
  public _assetCategories: AssetCategory = null;
  public get assetCategories(): AssetCategory { return this._assetCategories; }
  public set assetCategories(value: AssetCategory) {
    this._assetCategories = value;

    this.assetCategory = value;
  }

  public _partners: Partner = null;
  ...
  public updateDetails(asset: any) {
    ...
    if (asset.adm != null) {
      ...
      this.location = asset.adm.location; this.initialLocation=this.location.name;
      this.administration = asset.adm.administration; this.initialRoom=this.room.name
        ...
        .subscribe((result: CreateAssetSAPResult) => {
          ...
          if (result.success) {
            this.assetHttpService.getDetailById(this.asset.id)
              .subscribe((asset: any) => {
                if (asset != null) {
                  this.notificationService.showSuccess(result.errorMessage, 'Actualizare date', 5000, 0, 0);
                  this.isSaved = true;
                  this.updateDetails(asset);
                }
              });
  ...
  public setSelectedBudgetForecast() {
    const items: Array<BudgetForecast> = this.budgetChangeForecastList.selectedItems;
  ...
  public updateBudgetBase() {
    const budgetForecastId = this.selectedBudgetForecast != null ? this.selectedBudgetForecast.id : null;
    const data = new BudgetForecastUpdate();
