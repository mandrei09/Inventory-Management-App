...
@Component({
    selector: 'app-asset-detail-operation-transfer-ui',
    templateUrl: 'asset.detail-operation-transfer.ui.html',
    styleUrls: ['asset.detail-operation-transfer.ui.scss'],
...
export class AssetDetailUIOperationTransferComponent implements AfterViewInit, OnInit  {
    ...
    public get allowSaving(): boolean {
            ...
            (this.completeTransfer === true || this.priorYearAcquisitions === true || this.currentYearAcquisitions === true) &&
            this.uom != null;
    }
    ...
    public saveAsset() {
        this.isSaved = false;
        const saveAssetTr = new SaveAssetTransfer();
        ...
        if (saveAssetTr != null) {
            this.assetHttpService.newTransferAsset(saveAssetTr)
        ...
        //             .subscribe((asset: any) => {
        //                 if (asset != null) {
        //                     this.notifyService.showSuccess('', 'Datele au fost modificate cu succes!');
        //                     this.isSaved = true;
        //                     this.itemText = '';
        //                     this.refDocNo = '';
        //                     this.completeTransfer = false;
