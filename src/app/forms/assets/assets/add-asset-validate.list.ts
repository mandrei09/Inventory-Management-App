...
@Component({
    selector: 'add-asset-validate-list',
    templateUrl: '../../assets/assets/add-asset-validate.list.html',
    // host: {
...
export class AddAssetValidationListComponent extends GenericTableList<any, number> implements AfterViewInit {
    public query = '';
    public filteredList = [];
    public elementRef;
