...
@Component({
  ...
  templateUrl: './asset-retire-dialog.component.html',
  styleUrls: ['./asset-retire-dialog.component.scss']
})
export class AssetRetireDialogComponent implements AfterViewInit, OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<AssetRetireDialogComponent>,
