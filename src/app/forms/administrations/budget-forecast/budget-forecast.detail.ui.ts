...
@Component({
    selector: 'app-budget-forecast-detail-ui',
    templateUrl: 'budget-forecast.detail.ui.html',
    styleUrls: ['budget-forecast.detail.ui.scss'],
    providers: [
...
export class BudgetForecastDetailUIComponent implements AfterViewInit  {
    ...
    public saveBudget() {
        ...
        if (this.budget.id > 0) {
            ...
            .subscribe((res: RequestResult) => {
              if(res.success){
                this.notificationService.showSuccess(res.message, 'Actualizare buget', 2000, true, 0);
