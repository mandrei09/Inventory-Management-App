...
@Component({
  selector: "app-budget-forecast-validate-manage",
  templateUrl: "budget-forecast-validate.manage.html",
  styleUrls: ["budget-forecast-validate.manage.scss"],
  providers: [
...
export class BudgetForecastValidateManageComponent {
  // extends GenericManage<AssetInvDetail> {


  @ViewChild("budgetValidateList") public budgetValidateList: BudgetForecastListComponent;
