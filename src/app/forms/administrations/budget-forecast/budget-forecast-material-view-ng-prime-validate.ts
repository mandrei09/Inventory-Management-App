...
@Component({
    selector: 'app-budget-forecast-material-view-ng-prime-validate',
    templateUrl: './budget-forecast-material-view-ng-prime-validate.html',
    styleUrls: ['./budget-forecast-material-view-ng-prime-validate.scss'],
    providers: [MessageService],
    inputs: [ 'listTemplate' ],
})
export class BudgetForecastMaterialViewNgPrimeValidateListComponent extends GenericPrimeNgDataTableList<any, number> {
    public columns: any = [];

    public query = '';
    public filteredList = [];
    public elementRef;
    public listTemplate: string = 'BUDGETFORECASTUI';
