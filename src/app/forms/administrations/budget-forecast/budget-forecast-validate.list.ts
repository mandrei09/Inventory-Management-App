...
@Component({
  selector: 'app-budget-forecast-validate-list',
  templateUrl: 'budget-forecast-validate.list.html',
  inputs: ['listTemplate'],
  outputs: ['listAtferViewInit'],
})
export class BudgetForecastValidateListComponent
  extends GenericTableList<any, number>
  implements AfterViewInit {
  public query = '';
  public filteredList = [];
  public elementRef;
  public listTemplate: string = 'BUDGETFORECASTS';
