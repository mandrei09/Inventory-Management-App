...
@Component({
    selector: 'app-budget-forecast-transfer-detail-ui',
    templateUrl: 'budget-forecast-transfer.detail.ui.html',
    styleUrls: ['budget-forecast-transfer.detail.ui.scss'],
    providers: [
...
export class BudgetForecastTransferDetailUIComponent implements AfterViewInit  {
