...
@Component({
    selector: 'app-budget-forecast-ui-list',
    templateUrl: './budget-forecast.ui.list.html',
    styleUrls: ['./budget-forecast.ui.list.scss'],
    inputs: [ 'listTemplate' ],
    providers: [Table, TableService]
})
export class BudgetForecastUIListComponent extends GenericTableList<any, number> {
