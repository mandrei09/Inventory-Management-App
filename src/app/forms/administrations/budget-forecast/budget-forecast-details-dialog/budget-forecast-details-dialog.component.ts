...
@Component({
  selector: 'app-budget-forecast-details-dialog',
  templateUrl: './budget-forecast-details-dialog.component.html',
  styleUrls: ['./budget-forecast-details-dialog.component.scss']
})
export class BudgetForecastDetailsDialogComponent implements AfterViewInit {
