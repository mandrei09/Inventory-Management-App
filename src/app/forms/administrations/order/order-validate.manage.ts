...
@Component({
  selector: "order-validate-manage",
  templateUrl: "order-validate.manage.html",
  styleUrls: ["order-validate.manage.scss"],
  providers: [
...
export class OrderValidateManage {
  // extends GenericManage<AssetInvDetail> {

  @ViewChild("budgetValidateList") public budgetValidateList: OrderList;
  ...
  public budgetToUpdate = new Array<OrderValidate>();
  ...
  public saveValidated() {
    this.budgetToUpdate = new Array<OrderValidate>();
    ...
    this.orderHttpService.budgetValidate(this.budgetToUpdate).subscribe(
      (res) => {
