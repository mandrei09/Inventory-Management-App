...
import { OrderColumnFilter } from '../../../model/api/order/order-column-filter';
@Component({
    selector: 'app-order-list-ng-prime',
    // templateUrl: './order-list-ng-prime.html',
    // templateUrl: '../../generic/generic.table.list.html',
    // styleUrls: ['./order-list-ng-prime.scss'],
    templateUrl: '../../assets/assets/assets-filters-list/assets-filters.list.html',
    styleUrls: ['../../assets/assets/asset.list.scss'],
    providers: [MessageService],
    inputs: [ 'listTemplate' ],
})
// export class OrderListPrimeNgComponent extends GenericPrimeNgDataTableList<any, number> {
export class OrderListPrimeNgComponent extends GenericTableList<any, number> {

  public _code: string = null;
  public get code(): string { return this._code; }
  public set code(value: string) {
    this._code = value;
    this.getOrderColumnFilters();
  }
    ...
    public getOrderColumnFilters() {
      const params = new Array<Param>();
      let code: string;

      let assetColumnFilter: OrderColumnFilter;

       if (this.code) code = this.code;

      assetColumnFilter = new OrderColumnFilter(
        code,
      );
