...
@Component({
    selector: 'app-budget-month-base-list',
    templateUrl: './budget-month-base.list.html',
    // templateUrl: '../../generic/generic.table.list.html',
    styleUrls: ['./budget-month-base.list.scss'],
    inputs: [ 'listTemplate' ],
    providers: [Table, TableService]
})
export class BudgetMonthBaseListComponent extends GenericTableList<any, number> {
