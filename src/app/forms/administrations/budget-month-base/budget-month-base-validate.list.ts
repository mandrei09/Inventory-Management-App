...
@Component({
  selector: 'app-budget-month-base-validate-list',
  templateUrl: 'budget-month-base-validate.list.html',
  inputs: ['listTemplate'],
  outputs: ['listAtferViewInit'],
})
export class BudgetMonthBaseValidateListComponent
  extends GenericTableList<any, number>
  implements AfterViewInit {
  public query = '';
  public filteredList = [];
  public elementRef;
  public listTemplate: string = 'BUDGETMONTHBASES';
