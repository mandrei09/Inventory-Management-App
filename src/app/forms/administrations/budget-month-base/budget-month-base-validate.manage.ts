...
@Component({
  selector: "app-budget-month-base-validate-manage",
  templateUrl: "budget-month-base-validate.manage.html",
  styleUrls: ["budget-month-base-validate.manage.scss"],
  providers: [
...
export class BudgetMonthBaseValidateManageComponent {
  // extends GenericManage<AssetInvDetail> {

  @ViewChild("budgetValidateList") public budgetValidateList: BudgetMonthBaseListComponent;
  ...
  public budgetToUpdate = new Array<BudgetValidate>();
  ...
  public clearSelection() {
    this.budgetValidateList.selectedItems = this.selectedBudgetDetails;
  }
  ...
  public refreshAssets() {
    ...
    this.budgetValidateList.refresh(params);
    // this.assetRecoList.refresh(params);
  }

  public saveValidated() {
    this.budgetToUpdate = new Array<BudgetValidate>();
    ...
    this.budgetValidateList.TableItems.forEach((element) => {
    ...
    this.budgetHttpService.budgetValidate(this.budgetToUpdate).subscribe(
      (res) => {
  ...
  public getFilters(): Array<Param> {
    let params = new Array<Param>();
    let budgetFilter: BudgetFilter = new BudgetFilter();
