...
@Component({
    selector: 'app-order-material-order-validate-list',
...
export class OrderMaterialOrderValidateListComponent extends GenericTableList<any, number> implements AfterViewInit {
    public query = '';
    public filteredList = [];
    public elementRef;
