...
@Component({
  selector: "app-budget-base-validate-manage",
  templateUrl: "budget-base-validate.manage.html",
  styleUrls: ["budget-base-validate.manage.scss"],
  providers: [
...
export class BudgetBaseValidateManageComponent {
  // extends GenericManage<AssetInvDetail> {

  @ViewChild("budgetValidateList") public budgetValidateList: BudgetBaseListComponent;
