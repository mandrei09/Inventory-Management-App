...
export class BudgetEditDialogComponent implements AfterViewInit {
  ...
  public _country: CodeNameEntity = null;
  public get country(): CodeNameEntity { return this._country; }
  public set country(value: CodeNameEntity) {
    this._country = value;
  }

  public _activity: CodeNameEntity = null;
  public get activity(): CodeNameEntity { return this._activity; }
  public set activity(value: CodeNameEntity) {
    this._activity = value;
  }

  public _department: CodeNameEntity = null;
  public get department(): CodeNameEntity { return this._department; }
  public set department(value: CodeNameEntity) {
    this._department = value;
  }

  public _admCenter: CodeNameEntity = null;
  public get admCenter(): CodeNameEntity { return this._admCenter; }
  public set admCenter(value: CodeNameEntity) {
    this._admCenter = value;
  }

  public _region: CodeNameEntity = null;
  public get region(): CodeNameEntity { return this._region; }
  public set region(value: CodeNameEntity) {
    this._region = value;
  }

  public _division: CodeNameEntity = null;
  public get division(): CodeNameEntity { return this._division; }
  public set division(value: CodeNameEntity) {
    this._division = value;
  }

  public _implementationDate: AccMonth = null;
  public get implementationDate(): AccMonth { return this._implementationDate; }
  public set implementationDate(value: AccMonth) {
  ...
  public get executionDate(): AccMonth { return this._executionDate; }
  public set executionDate(value: AccMonth) {
  ...
  constructor(
    ...
    console.log(data.selectedBudget.id);
    if (data && data.selectedBudget) {
      this.id = data.selectedBudget.id;
    }
  ...
  public refreshRequestNeedBudgets() {
    const params = new Array<Param>();
    params.push(new Param('newBudget', 'true'));
    params.push(new Param('budgetForecastIds', this.id.toString()));
...
// }
  ...
  public updateDetails(budget: any) {
    ...
    this.budget.aprilForecastNew = budget.april;
    this.budget.mayForecastNew = budget.may;
    this.budget.juneForecastNew = budget.june;
    this.budget.julyForecastNew = budget.july;
    this.budget.augustForecastNew = budget.august;
    this.budget.septemberForecastNew = budget.september;
    this.budget.octomberForecastNew = budget.octomber;
    this.budget.novemberForecastNew = budget.november;

    this.budget.decemberForecastNew = budget.december;
    this.budget.januaryForecastNew = budget.january;
    this.budget.februaryForecastNew = budget.february;
    this.budget.marchForecastNew = budget.march;

    this.budget.totalForecast = budget.total;
    this.budget.totalForecastNew = budget.total;
    ...
    this.refreshRequestNeedBudgets();
  ...
  public saveBudget() {
    ...
    if (this.budget.id > 0) {
      this.budgetForecastHttpService.updateBudgetForecast(this.budget)
  ...
  public onRequestSelectionChanged(assets: Array<any>) {
    this.request = null;
    this.budgetValueNeedInitial = 0;
    this.budgetValueNeed = 0;
    const items: Array<Request> = assets;
    this.request = ((items != null) && (items.length === 1)) ? items[0] : null;
