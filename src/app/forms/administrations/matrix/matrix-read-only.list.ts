...
@Component({
    selector: 'app-matrix-validate-read-only-list',
    templateUrl: '../../administrations/matrix/matrix-read-only.list.html',
    inputs: [ 'listTemplate' ],
    outputs: [ 'listAtferViewInit' ]
})

export class MatrixValidateReadOnlyListComponent extends GenericTableList<any, number> implements AfterViewInit {
    public query = '';
    public filteredList = [];
    public elementRef;
    public listTemplate: string = 'MATRIX';
