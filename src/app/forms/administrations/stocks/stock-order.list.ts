...
@Component({
    ...
    // templateUrl: '../../administrations/stocks/stock.list.html',
    // templateUrl: '../../assets/assets/offer-stock-validate.list.html',
    templateUrl: '../../generic/generic.table.list.html',
    //templateUrl: '../../generic/generic.prime-ng-data-table.list.html',
    inputs: [ 'listTemplate' ],
})
export class StockOrderListComponent extends GenericTableList<any, number> implements AfterViewInit {
  //export class StockOrderListComponent extends GenericPrimeNgDataTableList<any, number> {
    public query = '';
    public filteredList = [];
    public elementRef;
    public listTemplate: string = 'STOCKS';
