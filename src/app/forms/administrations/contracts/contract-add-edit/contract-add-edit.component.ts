...
export class ContractAddEditComponent implements AfterViewInit {

    public _budget: Budget = null;
    public get budget(): Budget { return this._budget; }
    public set budget(value: Budget) {
      this._budget = value;
    }

    public _company: Company = null;
    ...
    public _assetType: CodeNameEntity = null;
    public get assetType(): CodeNameEntity { return this._assetType; }
    public set assetType(value: CodeNameEntity) {
