...
export class ContractListComponent extends GenericTableList<any, number> {
    public query = '';
    public filteredList = [];
    public elementRef;
    public listTemplate: string = 'CONTRACTS';
    ...
    @Output() public itemDelete: EventEmitter<any> = new EventEmitter<any>();
    @Output() public itemEdit: EventEmitter<any> = new EventEmitter<any>();
    @Output() public itemView: EventEmitter<any> = new EventEmitter<any>();
