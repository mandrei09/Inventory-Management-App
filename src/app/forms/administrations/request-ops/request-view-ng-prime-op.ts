...
@Component({
    selector: 'app-request-view-ng-prime-op',
    templateUrl: './request-view-ng-prime-op.html',
    styleUrls: ['./request-view-ng-prime-op.scss'],
    providers: [MessageService],
    inputs: [ 'listTemplate' ],
})
export class RequestViewNgPrimeOpListComponent extends GenericPrimeNgDataTableList<any, number> {
    public columns: any = [];

    public query = '';
    public filteredList = [];
    public elementRef;
    public listTemplate: string = 'REQUESTOPERATIONS';
