...
@Component({
    selector: 'app-request-detail-ui',
    templateUrl: 'request.detail.ui.html',
    styleUrls: ['request.detail.ui.scss'],
    providers: [
...
export class RequestDetailUIComponent implements OnInit, AfterViewInit  {
