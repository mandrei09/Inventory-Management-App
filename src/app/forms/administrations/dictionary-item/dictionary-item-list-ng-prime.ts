...
@Component({
    selector: 'app-dictionary-item-list-ng-prime',
    templateUrl: './dictionary-item-list-ng-prime.html',
    styleUrls: ['./dictionary-item-list-ng-prime.scss'],
    providers: [MessageService],
    inputs: [ 'listTemplate' ],
})
export class DictionaryItemListPrimeNgComponent extends GenericPrimeNgDataTableList<any, number> {
    public columns: any = [];

    public query = '';
    public filteredList = [];
    public elementRef;
    public listTemplate: string = 'DICTIONARYITEMS';
