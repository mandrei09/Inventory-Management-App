...
import { BudgetOpDetailList } from './budget-op.detail.list';
...
@Component({
    selector: 'budget-op-manage',
    templateUrl: 'budget-op-manage.html',
    styleUrls: ['budget-op-manage.scss'],
    providers: [
...
export class BudgetOpManage  {

    @ViewChild('assetOpDetailList') public assetOpList: BudgetOpDetailList;
