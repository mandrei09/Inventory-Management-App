...
@Component({
    selector: 'app-request-budget-forecast-view-ng-prime-validate',
    // templateUrl: './request-budget-forecast-view-ng-prime-validate.html',
    templateUrl: '../../generic/generic.table.list.html',
    styleUrls: ['./request-budget-forecast-view-ng-prime-validate.scss'],
    providers: [MessageService],
    inputs: [ 'listTemplate' ],
})
// export class RequestBudgetForecastViewNgPrimeValidateListComponent extends GenericPrimeNgDataTableList<any, number> {
export class RequestBudgetForecastViewNgPrimeValidateListComponent extends GenericTableList<any, number> {
    public columns: any = [];
