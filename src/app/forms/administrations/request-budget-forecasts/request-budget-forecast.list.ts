...
@Component({
    selector: 'app-request-budget-forecast-list',
    templateUrl: '../../assets/assets/offer-validate.list.html',
    inputs: [ 'listTemplate' ],
    outputs: [ 'listAtferViewInit'],
    styleUrls: ['request-budget-forecast.list.scss']

})
export class RequestBudgetForecastListComponent extends GenericTableList<any, number> implements AfterViewInit {
    public query = '';
    public filteredList = [];
    public elementRef;
