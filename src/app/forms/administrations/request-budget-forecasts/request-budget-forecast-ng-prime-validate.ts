...
@Component({
    selector: 'app-request-budget-forecast-ng-prime-validate',
    // templateUrl: './request-budget-forecast-ng-prime-validate.html',
    templateUrl: '../../generic/generic.table.list.html',
    styleUrls: ['./request-budget-forecast-ng-prime-validate.scss'],
    providers: [MessageService],
    inputs: [ 'listTemplate' ],
})
// export class RequestBudgetForecastNgPrimeValidateListComponent extends GenericPrimeNgDataTableList<any, number> {
export class RequestBudgetForecastNgPrimeValidateListComponent extends GenericTableList<any, number> {
    public columns: any = [];
