...
@Component({
    selector: 'app-offer-view-ng-prime-validate',
    // templateUrl: './offer-view-ng-prime-validate.html',
    templateUrl: '../../generic/generic.table.list.html',
    styleUrls: ['./offer-view-ng-prime-validate.scss'],
    providers: [MessageService],
    inputs: [ 'listTemplate' ],
})
export class OfferViewNgPrimeValidateListComponent extends GenericTableList<any, number> {
    public columns: any = [];
