...
@Component({
    selector: 'app-request-budget-forecast-material-view-ng-prime-validate',
    // templateUrl: './request-budget-forecast-material-view-ng-prime-validate.html',
    templateUrl: '../../generic/generic.table.list.html',
    // styleUrls: ['./request-budget-forecast-material-view-ng-prime-validate.scss'],
    providers: [MessageService],
    inputs: [ 'listTemplate' ],
})
// export class RequestBudgetForecastMaterialViewNgPrimeValidateListComponent extends GenericPrimeNgDataTableList<any, number> {
export class RequestBudgetForecastMaterialViewNgPrimeValidateListComponent extends GenericTableList<any, number> {
    public columns: any = [];
