...
@Component({
    selector: 'app-request-budget-forecast-material-validate-list',
    templateUrl: './request-budget-forecast-material-validate.list.html',
    inputs: [ 'listTemplate', 'materials' ],
    outputs: [ 'listAtferViewInit' ]
})
export class RequestBudgetForecastValidateListComponent extends GenericTableList<any, number> implements AfterViewInit {
    public query = '';
    public filteredList = [];
    public elementRef;
