...
@Component({
    selector: 'app-request-budget-forecast-material-list',
    templateUrl: '../../assets/assets/offer-validate.list.html',
    inputs: [ 'listTemplate' ],
    outputs: [ 'listAtferViewInit' ]
})
export class RequestBudgetForecastMaterialListComponent extends GenericTableList<any, number> implements AfterViewInit {
    public query = '';
    public filteredList = [];
    public elementRef;
    public listTemplate: string = 'REQUESTBUDGETFORECASTMATERIALS';
