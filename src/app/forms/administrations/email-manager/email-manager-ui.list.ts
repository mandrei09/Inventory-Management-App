...
@Component({
    selector: 'email-manager-ui-list',
    templateUrl: '../../administrations/email-manager/email-manager-ui.list.html',
    inputs: [ 'listTemplate' ],
})
export class EmailManagerUiList extends GenericTableList<any, number> {
    public query = '';
    public filteredList = [];
    public elementRef;
    public listTemplate: string = 'EMAILMANAGERS';
