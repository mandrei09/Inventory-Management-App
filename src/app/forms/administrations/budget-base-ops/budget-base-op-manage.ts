...
import { BudgetBaseOpDetailListComponent } from './budget-base-op.detail.list';


@Component({
    selector: 'app-budget-base-op-manage',
    templateUrl: 'budget-base-op-manage.html',
    styleUrls: ['budget-base-op-manage.scss'],
    providers: [
...
export class BudgetBaseOpManageComponent  {

    @ViewChild('assetOpDetailList') public assetOpList: BudgetBaseOpDetailListComponent;
