...
export class ArticleAddEditComponent implements AfterViewInit {

  public form!: FormGroup;
  public item!: Article | null;

  constructor(
    private fb: FormBuilder,
    public dialog: MatDialog,
    private dataSource: ArticleHttpService,
    public dialogRef: MatDialogRef<ArticleAddEditComponent>,
  ...
  public save() {
    ...
    if (this.item!.id! > 0) {
      ...
      this.dataSource.create(this.item!).subscribe((item: Article | null) => {
        this.item = item;
        this.dialogRef.close();
