...
@Component({
    selector: 'app-offer-material-order-validate-list',
...
export class OfferMaterialOrderValidateListComponent extends GenericTableList<any, number> implements AfterViewInit {
    public query = '';
    public filteredList = [];
    public elementRef;
