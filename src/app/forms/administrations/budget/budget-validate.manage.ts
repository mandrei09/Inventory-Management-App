...
@Component({
  selector: "budget-validate-manage",
  templateUrl: "budget-validate.manage.html",
  styleUrls: ["budget-validate.manage.scss"],
  providers: [
...
export class BudgetValidateManage {
  // extends GenericManage<AssetInvDetail> {

  @ViewChild("budgetValidateList") public budgetValidateList: BudgetList;
