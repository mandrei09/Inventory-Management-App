...
@Component({
    selector: 'budget-primeng-list',
    templateUrl: './budget-primeng.list.html',
    styleUrls: ['./budget-primeng.list.scss'],
    inputs: [ 'listTemplate' ],
    providers: [Table, TableService]
})
// export class BudgetList extends GenericTableList<any, number> {
export class BudgetPrimeNgList extends GenericPrimeNgDataTableList<any, number> {
    public columns: any = [];
