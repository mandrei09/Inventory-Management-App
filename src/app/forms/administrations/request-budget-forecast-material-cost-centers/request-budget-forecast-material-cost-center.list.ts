...
@Component({
    selector: 'app-request-budget-forecast-material-cost-center-list',
    templateUrl: '../../assets/assets/offer-validate.list.html',
    inputs: [ 'listTemplate' ],
    outputs: [ 'listAtferViewInit' ]
})
export class RequestBudgetForecastMaterialCostCenterListComponent extends GenericTableList<any, number> implements AfterViewInit {
    public query = '';
    public filteredList = [];
    public elementRef;
