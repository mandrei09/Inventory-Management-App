...
@Component({
  selector: 'app-exp-account-add-edit',
  templateUrl: './exp-account-add-edit.component.html',
  styleUrls: ['./exp-account-add-edit.component.scss']
})
export class ExpAccountAddEditComponent implements AfterViewInit {

  public form!: FormGroup;
  public item!: ExpAccount | null;

  constructor(
    private fb: FormBuilder,
    public dialog: MatDialog,
    private dataSource: ExpAccountHttpService,
    public dialogRef: MatDialogRef<ExpAccountAddEditComponent>,
  ...
  public editItem(item: ExpAccount) {
  ...
  public save() {
    ...
    if (this.item!.id! > 0) {
      ...
      this.dataSource.create(this.item!).subscribe((item: ExpAccount | null) => {
        this.item = item;
        this.dialogRef.close();
